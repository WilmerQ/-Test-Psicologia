...
/**
 *TestPataNegraConAcomp clase que es utilizada para generar el reporte cuando solo el
 * test Pata Negra esta activo y se realizo con acompañante. se encuentran todos los
 * campos referentes a las preguntas de manera individual.
 * @see Acompanante
 * @author Jorge
 */
public class TestPataNegraConAcomp extends Acompanante {
