...
public class LogicaEmail {
    ...
    public void EnviarEmail(String Asunto) {
        ...
        destino.add("Jorger.quintero@outlook.com");
        destino.add("Jorger.quintero@campusucc.edu.co");
    ...
    public void enviarCorreoelectronico(
        ...
        try {
            ...
            String username = "deapsico.invesgacion@gmail.com";
            String password = "deapsico.2017";
            ...
            message.setFrom(new InternetAddress("deapsico.invesgacion@gmail.com"));
